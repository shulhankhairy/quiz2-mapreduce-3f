# Variabel-variabel
FILE_JAR=target/Kuis_2-1.0-SNAPSHOT.jar
HADOOP_USERNAME=hadoopuser
IP_NAMENODE=192.168.100.210
HOME_DIR=/home/hadoopuser/
NAMA_JAR_TUJUAN=kuis_2.jar
PACKAGE_ID=org.example.App
INPUT_FOLDER=/Dhiyashafa/Input/Kuis2/dataMakanan2
OUTPUT_FOLDER=/Dhiyashafa/Output/hasil-kuis2

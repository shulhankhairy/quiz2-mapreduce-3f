# Variabel-variabel
FILE_JAR=target/Kuis2BigData-1.0-SNAPSHOT.jar
HADOOP_USERNAME=hadoopuser
IP_NAMENODE=192.168.1.14
HOME_DIR=/home/hadoopuser/
NAMA_JAR_TUJUAN=kuis2.jar
PACKAGE_ID=org.example.App
INPUT_FOLDER=/Savinalintang/Input/Kuis2/dataCameraa
OUTPUT_FOLDER=/Savinalintang/Output/hasil-kuis2
